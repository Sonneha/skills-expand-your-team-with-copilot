document.addEventListener("DOMContentLoaded", () => {
  ...
  // Function to normalize optional difficulty data
  function getActivityDifficulty(details) {
    ...
    const difficulty =
      typeof details.difficulty === "string"
        ...
        : "";
    return difficultyLevels.includes(difficulty) ? difficulty : "";
  }
  ...
  function renderActivityCard(name, details) {
    ...
    const difficultyHtml = activityDifficulty
      ? `<p><strong>Difficulty:</strong> ${
          activityDifficulty.charAt(0).toUpperCase() +
          activityDifficulty.slice(1)
        }</p>`
      : "";
